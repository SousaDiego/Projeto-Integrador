...
<body>
    ...
    <?php if($nivelDeAcesso == 1): ?>
        <h1 class="h1_aula">Aula 7 - Reconhecimento Web - Encontrando vulnerabilidades</h1>
        ...
        <div class="div_tabela_aula">
            ...
            <div style="background-color: white;float: left;margin: 10px;box-shadow: 5px 5px 10px 1px;">
                ...
                <ul>
                    ...
                    <a href="introducao8.php"> 
                        <li class="li_aulas">Aula 8 - SQL Injection - Atacando o Servidor</li>
                    </a>
                    <a href="introducao9.php"> 
                        <li class="li_aulas">Aula 9 - Cross-Site Scripting (XSS) - Atacando o Cliente</li>
                    </a>
