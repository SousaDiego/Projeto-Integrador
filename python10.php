...
<body>
    ...
    <?php if($pagamento == 3 || $pagamento == 4): ?>
        <h1 class="h1_aula">Aula 10 - Entrada e saída de arquivos</h1>
        ...
        <div class="div_tabela_aula">
            ...
            <div style="background-color: white;float: left;margin: 10px;box-shadow: 5px 5px 10px 1px;">
                ...
                <ul>
                     <a href="python10.php">
                        <li class="li_aulas">Aula 10 - Entrada e saída de arquivos</li>
                    </a>
                    <a href="python11.php">
                        <li class="li_aulas">Aula 11 - Tratamentos de erros e exceções (TRY e EXCEPT)</li>
                    </a>
                    <a href="python12.php"> 
                        <li class="li_aulas">Aula 12 - Bibliotecas, PIP e Requisições Web</li>
                    </a>
                    <a href="python13.php">
                        <li class="li_aulas">Aula 13 - API, JSON e consultando listas de filmes</li>
                    </a>
                    <a href="python14.php">
