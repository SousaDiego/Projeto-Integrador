...
<body>
    ...
    <?php if($nivelDeAcesso == 1): ?>
        <h1 class="h1_aula">Aula 1 - Como ser um Hacker - O que é um Pentest?</h1>
        ...
        <div class="div_tabela_aula">
            ...
            <div style="background-color: white;float: left;margin: 10px;box-shadow: 5px 5px 10px 1px;">
                ...
                <ul>
                    <a href="restritaIntroducao.php"> 
                        <li class="li_aulas">Aula 1 - Como ser um Hacker - O que é um Pentest?</li>
                    </a>
                    <a href="introducao1.php"> 
                        <li class="li_aulas">Aula 2 - Instalando o sistema dos Hackers - Kali Linux</li>
                    </a>
